...
from dataloader_regression import sentiment_analysis_dataset, MyCollator
...
class BERTClassifier(pl.LightningModule):
    ...
    def __build_loss(self):
        ...
        # self.Weightloss2 = torch.tensor(torch.FloatTensor([self.hparams.loss_aux]), requires_grad=True, device='cuda')
        #self.params = [Weightloss1, Weightloss2]
